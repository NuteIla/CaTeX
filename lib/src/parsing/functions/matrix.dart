...
import 'package:catex/src/rendering/functions/matrix.dart';
import 'package:catex/src/widgets.dart';

// ignore: public_member_api_docs
class MatrixNode extends MultiChildNode<RenderMatrix>
    with FunctionNode<RenderMatrix> {
  // ignore: public_member_api_docs
  MatrixNode(ParsingContext context) : super(context);
  ...
  @override
  NodeWidget<RenderMatrix> configureWidget(CaTeXContext context) {
  ...
  @override
  RenderMatrix createRenderNode(CaTeXContext context) {
    return RenderMatrix(context);
  }
}
